...
const anchorEnd = `<div className="summary-note" style={{ fontSize: '0.9rem', color: 'rgba(0,0,0,0.8)', lineHeight: 1.5, padding: '0 1rem 0.75rem' }}>`;
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  code = code.substring(0, startIdx) + newBlock + code.substring(endIdx + anchorEnd.length);
