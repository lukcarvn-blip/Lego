                        ...
                        <div className="flash-container-wrapper" style={{ position: 'relative', width: '100%', aspectRatio: '16/7', backgroundColor: '#050505', overflow: 'hidden', borderRadius: 'var(--radius-md)' }}>
                          ...
                          <div className="flash-badge-container flash-hud-delayed">
                            ...
                            {product.collection && settings.collections?.find((c: any) => c.name === product.collection) && (() => {
                              ...
                              return (
                                <div className="flash-badge hover-jump" style={{ background: col.bg, border: `1px solid ${col.border || 'rgba(255,255,255,0.2)'}`, color: col.color }}>
                                  <IconComponent />
                            ...
                            {/* Category Badge */}
                            {product.category && (
                              <div className="flash-badge hover-jump">
                                <Icons.Layers />
              ...
              return (
                ...
                {showAd1 && (
                  <div className="product-card request-card-bg fan-cung-shine" style={{
                    ...
                    <Icons.MessageSquarePlus size={32} color="var(--color-accent)" style={{ marginBottom: '1rem', zIndex: 10 }} />
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--color-accent)', fontWeight: 800, fontSize: '0.9rem', marginBottom: '0.5rem', zIndex: 10, textTransform: 'uppercase' }}>
                      <Icons.Star size={16} fill="var(--color-accent)" />
