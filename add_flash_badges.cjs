...
if (code.includes(targetBadges.replace(/\\\\r\\\\n/g, '\\r\\n'))) {
  code = code.replace(targetBadges.replace(/\\\\r\\\\n/g, '\\r\\n'), replaceBadges.replace(/\\\\r\\\\n/g, '\\r\\n'));
  console.log("Matched CRLF");
} else if (code.includes(targetBadges.replace(/\\\\r\\\\n/g, '\\n'))) {
  code = code.replace(targetBadges.replace(/\\\\r\\\\n/g, '\\n'), replaceBadges.replace(/\\\\r\\\\n/g, '\\n'));
  console.log("Matched LF");
} else {
